...
<template>
  <div>
    <div class="main__container">
      ...
      ></textarea>
      <textarea
        v-model="finishedQuestions"
        type="textarea"
        placeholder="Answers will show up here."
        rows="35"
        cols="50"
      >
      </textarea>
      <button v-if="finishedQuestions" @click="copyQuestions" class="main__copy-button">
        {{ copyText }}
      </button>
    </div>
    <div class="main__btn-container">
      ...
      <button @click="shuffleQuestions('qa')" :disabled="!inputQuestions">
